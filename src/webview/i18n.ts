...
const en = {
  ...
  headerRenameTitle: "Double-click to rename this session",
  newSession: "New",
  newSessionTitle: "Start a new session on this surface",
  sessions: "Sessions",
  ...
  entrySwitchReplyTitle:
    "Move the session back to this reply and continue from it. The abandoned branch is kept and stays reachable from the session tree.",
  entryFork: "Fork",
  entryForkTitle: "Copy the branch up to this message into a new session file",
  entryForkReplyTitle: "Copy the branch through this reply into a new session file",
  entryLabel: "Label",
  ...
  fileHintIgnoredHidden: "@ project paths · Ctrl+→ to show gitignored paths",
  fileHintIgnoredShown: "@ project paths (including gitignored) · Ctrl+→ to hide them",
  ...
  noticeContinueTitle: "Resume the stopped run, without adding a message to the conversation",
  noticeContinuing: "Continuing...",
  noticeContinueSucceeded: "Continued",
  noticeContinueFailed: "Cannot continue",
  expand: "Expand",
  collapse: "Collapse",
  ...
  gotoMessageStart: "Back to start",
  gotoMessageStartTitle: "Scroll to the start of this message",
  ...
  sessionOpenElsewhere: "open in another view",
  sessionOpenElsewhereTitle: "Move this session here; the other chat view will start a new session",
  sessionRunningInBackground: "running in background",
  sessionBackgroundTitle: "Bring this background session back to this chat view",
  ...
  search: "Search",
  searchTitle: "Search the transcript",
...
const zh: Dict = {
  newSessionLabel: "新会话",
  headerRenameTitle: "双击重命名这个会话",
  newSession: "新会话",
  newSessionTitle: "在当前界面开始新会话",
  sessions: "会话列表",
  ...
  entrySwitchReplyTitle: "把会话回到这条回答，并从这里继续。被放弃的分支会保留，随时可从会话树切回。",
  entryFork: "分叉",
  entryForkTitle: "把到这条消息为止的分支复制到新的会话文件",
  entryForkReplyTitle: "把包含这条回答在内的分支复制到新的会话文件",
  entryLabel: "标签",
  ...
  fileHintIgnoredHidden: "@ 项目路径 · Ctrl+→ 显示被 gitignore 的路径",
  fileHintIgnoredShown: "@ 项目路径（含 gitignore）· Ctrl+→ 隐藏它们",
  fileIgnoredBadge: "已忽略",
  fileSensitiveBadge: "敏感",
  fileRemoveTitle: "移除项目引用",
  ...
  noticeContinue: "继续",
  noticeContinueTitle: "恢复被停止的那次运行，不会在对话里多出一条消息",
  noticeContinuing: "继续中...",
  noticeContinueSucceeded: "已继续",
  noticeContinueFailed: "无法继续",
  expand: "展开",
  collapse: "收起",
  copyMessage: "复制消息",
  ...
  expandMessage: "展开全文",
  collapseMessage: "收起",
  gotoMessageStart: "回到开头",
  gotoMessageStartTitle: "滚动到这条消息的开头",
  thinkingHeader: "思考中...",
  thinkingDone: "思考完成",
  workHeader: "执行过程",
  ...
  sessionCurrent: "当前",
  sessionRunning: "运行中",
  sessionOpenElsewhere: "已在另一处打开",
  sessionOpenElsewhereTitle: "将此会话移到这里；原聊天视图会切换为空的新会话",
  sessionRunningInBackground: "后台运行中",
  sessionBackgroundTitle: "将这个后台会话移回当前聊天视图",
  sessionDelete: "删除",
