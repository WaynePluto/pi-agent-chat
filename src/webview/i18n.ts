...
const en = {
  ...
  inputPlaceholder: "Ask Pi...  (Enter to send, Shift/Ctrl+Enter for newline, / commands, @ files, paste screenshots)",
...
const zh: Dict = {
  ...
  inputPlaceholder: "问问 Pi...（Enter 发送，Shift/Ctrl+Enter 换行，/ 命令，@ 引用文件，可粘贴截图）",
