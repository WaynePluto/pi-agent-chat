/** webview 各处使用的内联 SVG 图标。硬编码，绝非模型输出。 */
...
/* Codicon 路径，逐字取自 microsoft/vscode-codicons（src/icons/arrow-up.svg、
 * arrow-down.svg、close.svg）：与 workbench 查找组件同一套字形。不要手工
 * 精简——几何本身就是设计。 */
